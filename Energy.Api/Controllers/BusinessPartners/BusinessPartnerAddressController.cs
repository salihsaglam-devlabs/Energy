...
using Energy.Application.Modules.BusinessPartners.BusinessPartnerAddress.Commands.CreateBusinessPartnerAddress;
using Energy.Application.Modules.BusinessPartners.BusinessPartnerAddress.Commands.DeleteBusinessPartnerAddress;
using Energy.Application.Modules.BusinessPartners.BusinessPartnerAddress.Commands.UpdateBusinessPartnerAddress;
using Energy.Application.Modules.BusinessPartners.BusinessPartnerAddress.Queries.GetBusinessPartnerAddressById;
using Energy.Application.Modules.BusinessPartners.BusinessPartnerAddress.Queries.GetBusinessPartnerAddressList;
using Energy.Application.Modules.BusinessPartners.BusinessPartnerAddress.Queries.GetBusinessPartnerAddressLookup;
