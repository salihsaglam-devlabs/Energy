...
using Energy.Application.BusinessPartners.BusinessPartnerContact.Commands.CreateBusinessPartnerContact;
using Energy.Application.BusinessPartners.BusinessPartnerContact.Commands.DeleteBusinessPartnerContact;
using Energy.Application.BusinessPartners.BusinessPartnerContact.Commands.UpdateBusinessPartnerContact;
using Energy.Application.BusinessPartners.BusinessPartnerContact.Queries.GetBusinessPartnerContactById;
using Energy.Application.BusinessPartners.BusinessPartnerContact.Queries.GetBusinessPartnerContactList;
using Energy.Application.BusinessPartners.BusinessPartnerContact.Queries.GetBusinessPartnerContactLookup;
