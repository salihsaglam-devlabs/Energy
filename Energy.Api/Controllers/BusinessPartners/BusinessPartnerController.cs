...
using Energy.Application.Modules.BusinessPartners.BusinessPartner.Commands.CreateBusinessPartner;
using Energy.Application.Modules.BusinessPartners.BusinessPartner.Commands.DeleteBusinessPartner;
using Energy.Application.Modules.BusinessPartners.BusinessPartner.Commands.UpdateBusinessPartner;
using Energy.Application.Modules.BusinessPartners.BusinessPartner.Queries.GetBusinessPartnerById;
using Energy.Application.Modules.BusinessPartners.BusinessPartner.Queries.GetBusinessPartnerList;
using Energy.Application.Modules.BusinessPartners.BusinessPartner.Queries.GetBusinessPartnerLookup;
