...
using Energy.Application.Modules.Catalog.MaterialAttributeDefinition.Commands.CreateMaterialAttributeDefinition;
using Energy.Application.Modules.Catalog.MaterialAttributeDefinition.Commands.DeleteMaterialAttributeDefinition;
using Energy.Application.Modules.Catalog.MaterialAttributeDefinition.Commands.UpdateMaterialAttributeDefinition;
using Energy.Application.Modules.Catalog.MaterialAttributeDefinition.Queries.GetMaterialAttributeDefinitionById;
using Energy.Application.Modules.Catalog.MaterialAttributeDefinition.Queries.GetMaterialAttributeDefinitionList;
using Energy.Application.Modules.Catalog.MaterialAttributeDefinition.Queries.GetMaterialAttributeDefinitionLookup;
