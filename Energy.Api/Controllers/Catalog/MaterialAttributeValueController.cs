...
using Energy.Application.Modules.Catalog.MaterialAttributeValue.Commands.CreateMaterialAttributeValue;
using Energy.Application.Modules.Catalog.MaterialAttributeValue.Commands.DeleteMaterialAttributeValue;
using Energy.Application.Modules.Catalog.MaterialAttributeValue.Commands.UpdateMaterialAttributeValue;
using Energy.Application.Modules.Catalog.MaterialAttributeValue.Queries.GetMaterialAttributeValueById;
using Energy.Application.Modules.Catalog.MaterialAttributeValue.Queries.GetMaterialAttributeValueList;
using Energy.Application.Modules.Catalog.MaterialAttributeValue.Queries.GetMaterialAttributeValueLookup;
