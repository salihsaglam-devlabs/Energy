...
using Energy.Application.Modules.Catalog.MaterialCategory.Commands.CreateMaterialCategory;
using Energy.Application.Modules.Catalog.MaterialCategory.Commands.DeleteMaterialCategory;
using Energy.Application.Modules.Catalog.MaterialCategory.Commands.UpdateMaterialCategory;
using Energy.Application.Modules.Catalog.MaterialCategory.Queries.GetMaterialCategoryById;
using Energy.Application.Modules.Catalog.MaterialCategory.Queries.GetMaterialCategoryList;
using Energy.Application.Modules.Catalog.MaterialCategory.Queries.GetMaterialCategoryLookup;
