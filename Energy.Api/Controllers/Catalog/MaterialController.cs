...
using Energy.Application.Catalog.Material.Commands.CreateMaterial;
using Energy.Application.Catalog.Material.Commands.DeleteMaterial;
using Energy.Application.Catalog.Material.Commands.UpdateMaterial;
using Energy.Application.Catalog.Material.Queries.GetMaterialById;
using Energy.Application.Catalog.Material.Queries.GetMaterialList;
using Energy.Application.Catalog.Material.Queries.GetMaterialLookup;
