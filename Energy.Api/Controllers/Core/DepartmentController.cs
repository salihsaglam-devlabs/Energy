...
using Energy.Application.Modules.Core.Department.Commands.CreateDepartment;
using Energy.Application.Modules.Core.Department.Commands.DeleteDepartment;
using Energy.Application.Modules.Core.Department.Commands.UpdateDepartment;
using Energy.Application.Modules.Core.Department.Queries.GetDepartmentById;
using Energy.Application.Modules.Core.Department.Queries.GetDepartmentList;
using Energy.Application.Modules.Core.Department.Queries.GetDepartmentLookup;
