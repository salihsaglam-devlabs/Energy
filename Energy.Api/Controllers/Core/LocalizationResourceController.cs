...
using Energy.Application.Modules.Core.LocalizationResource.Commands.CreateLocalizationResource;
using Energy.Application.Modules.Core.LocalizationResource.Commands.DeleteLocalizationResource;
using Energy.Application.Modules.Core.LocalizationResource.Commands.UpdateLocalizationResource;
using Energy.Application.Modules.Core.LocalizationResource.Queries.GetLocalizationResourceById;
using Energy.Application.Modules.Core.LocalizationResource.Queries.GetLocalizationResourceList;
using Energy.Application.Modules.Core.LocalizationResource.Queries.GetLocalizationResourceLookup;
