...
using Energy.Application.Core.SystemSetting.Commands.CreateSystemSetting;
using Energy.Application.Core.SystemSetting.Commands.DeleteSystemSetting;
using Energy.Application.Core.SystemSetting.Commands.UpdateSystemSetting;
using Energy.Application.Core.SystemSetting.Queries.GetSystemSettingById;
using Energy.Application.Core.SystemSetting.Queries.GetSystemSettingList;
using Energy.Application.Core.SystemSetting.Queries.GetSystemSettingLookup;
