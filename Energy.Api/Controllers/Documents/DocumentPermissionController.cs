...
using Energy.Application.Modules.Documents.DocumentPermission.Commands.CreateDocumentPermission;
using Energy.Application.Modules.Documents.DocumentPermission.Commands.DeleteDocumentPermission;
using Energy.Application.Modules.Documents.DocumentPermission.Commands.UpdateDocumentPermission;
using Energy.Application.Modules.Documents.DocumentPermission.Queries.GetDocumentPermissionById;
using Energy.Application.Modules.Documents.DocumentPermission.Queries.GetDocumentPermissionList;
using Energy.Application.Modules.Documents.DocumentPermission.Queries.GetDocumentPermissionLookup;
