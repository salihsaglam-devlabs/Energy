...
using Energy.Application.FieldOperations.DailySiteReport.Commands.CreateDailySiteReport;
using Energy.Application.FieldOperations.DailySiteReport.Commands.DeleteDailySiteReport;
using Energy.Application.FieldOperations.DailySiteReport.Commands.UpdateDailySiteReport;
using Energy.Application.FieldOperations.DailySiteReport.Queries.GetDailySiteReportById;
using Energy.Application.FieldOperations.DailySiteReport.Queries.GetDailySiteReportList;
using Energy.Application.FieldOperations.DailySiteReport.Queries.GetDailySiteReportLookup;
