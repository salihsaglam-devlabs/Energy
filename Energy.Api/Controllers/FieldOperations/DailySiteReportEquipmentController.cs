...
using Energy.Application.FieldOperations.DailySiteReportEquipment.Commands.CreateDailySiteReportEquipment;
using Energy.Application.FieldOperations.DailySiteReportEquipment.Commands.DeleteDailySiteReportEquipment;
using Energy.Application.FieldOperations.DailySiteReportEquipment.Commands.UpdateDailySiteReportEquipment;
using Energy.Application.FieldOperations.DailySiteReportEquipment.Queries.GetDailySiteReportEquipmentById;
using Energy.Application.FieldOperations.DailySiteReportEquipment.Queries.GetDailySiteReportEquipmentList;
using Energy.Application.FieldOperations.DailySiteReportEquipment.Queries.GetDailySiteReportEquipmentLookup;
