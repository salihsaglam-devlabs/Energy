...
using Energy.Application.Modules.FieldOperations.DailySiteReportMaterial.Commands.CreateDailySiteReportMaterial;
using Energy.Application.Modules.FieldOperations.DailySiteReportMaterial.Commands.DeleteDailySiteReportMaterial;
using Energy.Application.Modules.FieldOperations.DailySiteReportMaterial.Commands.UpdateDailySiteReportMaterial;
using Energy.Application.Modules.FieldOperations.DailySiteReportMaterial.Queries.GetDailySiteReportMaterialById;
using Energy.Application.Modules.FieldOperations.DailySiteReportMaterial.Queries.GetDailySiteReportMaterialList;
using Energy.Application.Modules.FieldOperations.DailySiteReportMaterial.Queries.GetDailySiteReportMaterialLookup;
