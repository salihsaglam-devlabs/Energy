...
using Energy.Application.Finance.CollectionAllocation.Commands.CreateCollectionAllocation;
using Energy.Application.Finance.CollectionAllocation.Commands.DeleteCollectionAllocation;
using Energy.Application.Finance.CollectionAllocation.Commands.UpdateCollectionAllocation;
using Energy.Application.Finance.CollectionAllocation.Queries.GetCollectionAllocationById;
using Energy.Application.Finance.CollectionAllocation.Queries.GetCollectionAllocationList;
using Energy.Application.Finance.CollectionAllocation.Queries.GetCollectionAllocationLookup;
