...
/// <summary>EquipmentAsset uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class EquipmentAssetController : ControllerBase
{
    ...
    public EquipmentAssetController(IEquipmentAssetService service, IEquipmentAssetLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
