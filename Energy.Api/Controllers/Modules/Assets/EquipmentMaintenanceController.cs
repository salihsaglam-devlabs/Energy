...
/// <summary>EquipmentMaintenance uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class EquipmentMaintenanceController : ControllerBase
{
    ...
    public EquipmentMaintenanceController(IEquipmentMaintenanceService service, IEquipmentMaintenanceLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
