...
/// <summary>Material uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class MaterialController : ControllerBase
{
    ...
    public MaterialController(IMaterialService service, IMaterialLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
