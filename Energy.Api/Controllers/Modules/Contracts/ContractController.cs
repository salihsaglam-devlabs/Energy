...
/// <summary>Contract uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class ContractController : ControllerBase
{
    ...
    public ContractController(IContractService service, IContractLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
