...
/// <summary>ContractParty uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class ContractPartyController : ControllerBase
{
    ...
    public ContractPartyController(IContractPartyService service, IContractPartyLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
