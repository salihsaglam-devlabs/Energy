...
/// <summary>Department uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class DepartmentController : ControllerBase
{
    ...
    public DepartmentController(IDepartmentService service, IDepartmentLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
