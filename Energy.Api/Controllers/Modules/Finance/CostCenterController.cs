...
/// <summary>CostCenter uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class CostCenterController : ControllerBase
{
    ...
    public CostCenterController(ICostCenterService service, ICostCenterLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
