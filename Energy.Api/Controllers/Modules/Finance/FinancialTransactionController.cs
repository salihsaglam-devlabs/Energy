...
/// <summary>FinancialTransaction uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class FinancialTransactionController : ControllerBase
{
    ...
    public FinancialTransactionController(IFinancialTransactionService service, IFinancialTransactionLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
