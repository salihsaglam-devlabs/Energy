...
/// <summary>Payable uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class PayableController : ControllerBase
{
    ...
    public PayableController(IPayableService service, IPayableLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
