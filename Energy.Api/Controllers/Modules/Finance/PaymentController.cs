...
/// <summary>Payment uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class PaymentController : ControllerBase
{
    ...
    public PaymentController(IPaymentService service, IPaymentLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
