...
/// <summary>StockCount uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class StockCountController : ControllerBase
{
    ...
    public StockCountController(IStockCountService service, IStockCountLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
