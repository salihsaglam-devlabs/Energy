...
/// <summary>Notification uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class NotificationController : ControllerBase
{
    ...
    public NotificationController(INotificationService service, INotificationLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
