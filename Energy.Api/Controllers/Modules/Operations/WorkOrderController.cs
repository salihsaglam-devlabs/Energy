...
/// <summary>WorkOrder uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class WorkOrderController : ControllerBase
{
    ...
    public WorkOrderController(IWorkOrderService service, IWorkOrderLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
