...
/// <summary>Employee uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class EmployeeController : ControllerBase
{
    ...
    public EmployeeController(IEmployeeService service, IEmployeeLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
