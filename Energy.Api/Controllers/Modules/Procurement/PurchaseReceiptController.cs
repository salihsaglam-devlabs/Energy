...
/// <summary>PurchaseReceipt uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class PurchaseReceiptController : ControllerBase
{
    ...
    public PurchaseReceiptController(IPurchaseReceiptService service, IPurchaseReceiptLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
