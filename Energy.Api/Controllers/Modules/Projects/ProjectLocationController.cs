...
/// <summary>ProjectLocation uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class ProjectLocationController : ControllerBase
{
    ...
    public ProjectLocationController(IProjectLocationService service, IProjectLocationLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
