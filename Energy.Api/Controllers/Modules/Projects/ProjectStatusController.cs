...
/// <summary>ProjectStatus uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class ProjectStatusController : ControllerBase
{
    ...
    public ProjectStatusController(IProjectStatusService service, IProjectStatusLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
