...
/// <summary>ProjectType uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class ProjectTypeController : ControllerBase
{
    ...
    public ProjectTypeController(IProjectTypeService service, IProjectTypeLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
