...
/// <summary>DashboardWidget uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class DashboardWidgetController : ControllerBase
{
    ...
    public DashboardWidgetController(IDashboardWidgetService service, IDashboardWidgetLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
