...
/// <summary>Request uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class RequestController : ControllerBase
{
    ...
    public RequestController(IRequestService service, IRequestLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
