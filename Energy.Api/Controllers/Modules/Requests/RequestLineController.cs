...
/// <summary>RequestLine uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class RequestLineController : ControllerBase
{
    ...
    public RequestLineController(IRequestLineService service, IRequestLineLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
