...
/// <summary>ApprovalCondition uç noktaları (liste, detay, lookup, create, update, delete).</summary>
[ApiController]
[ApiVersion("1.0")]
...
public sealed class ApprovalConditionController : ControllerBase
{
    ...
    public ApprovalConditionController(IApprovalConditionService service, IApprovalConditionLookupService lookup)
    {
        _service = service;
        _lookup = lookup;
    }
