...
using Energy.Application.Notifications.NotificationPreference.Commands.CreateNotificationPreference;
using Energy.Application.Notifications.NotificationPreference.Commands.DeleteNotificationPreference;
using Energy.Application.Notifications.NotificationPreference.Commands.UpdateNotificationPreference;
using Energy.Application.Notifications.NotificationPreference.Queries.GetNotificationPreferenceById;
using Energy.Application.Notifications.NotificationPreference.Queries.GetNotificationPreferenceList;
using Energy.Application.Notifications.NotificationPreference.Queries.GetNotificationPreferenceLookup;
