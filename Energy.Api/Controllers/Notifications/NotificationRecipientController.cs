...
using Energy.Application.Notifications.NotificationRecipient.Commands.CreateNotificationRecipient;
using Energy.Application.Notifications.NotificationRecipient.Commands.DeleteNotificationRecipient;
using Energy.Application.Notifications.NotificationRecipient.Commands.UpdateNotificationRecipient;
using Energy.Application.Notifications.NotificationRecipient.Queries.GetNotificationRecipientById;
using Energy.Application.Notifications.NotificationRecipient.Queries.GetNotificationRecipientList;
using Energy.Application.Notifications.NotificationRecipient.Queries.GetNotificationRecipientLookup;
