...
using Energy.Application.Modules.Operations.WorkOrder.Commands.CreateWorkOrder;
using Energy.Application.Modules.Operations.WorkOrder.Commands.DeleteWorkOrder;
using Energy.Application.Modules.Operations.WorkOrder.Commands.UpdateWorkOrder;
using Energy.Application.Modules.Operations.WorkOrder.Queries.GetWorkOrderById;
using Energy.Application.Modules.Operations.WorkOrder.Queries.GetWorkOrderList;
using Energy.Application.Modules.Operations.WorkOrder.Queries.GetWorkOrderLookup;
