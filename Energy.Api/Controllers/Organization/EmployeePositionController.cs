...
using Energy.Application.Organization.EmployeePosition.Commands.CreateEmployeePosition;
using Energy.Application.Organization.EmployeePosition.Commands.DeleteEmployeePosition;
using Energy.Application.Organization.EmployeePosition.Commands.UpdateEmployeePosition;
using Energy.Application.Organization.EmployeePosition.Queries.GetEmployeePositionById;
using Energy.Application.Organization.EmployeePosition.Queries.GetEmployeePositionList;
using Energy.Application.Organization.EmployeePosition.Queries.GetEmployeePositionLookup;
