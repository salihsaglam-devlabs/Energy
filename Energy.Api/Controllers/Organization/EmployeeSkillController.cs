...
using Energy.Application.Organization.EmployeeSkill.Commands.CreateEmployeeSkill;
using Energy.Application.Organization.EmployeeSkill.Commands.DeleteEmployeeSkill;
using Energy.Application.Organization.EmployeeSkill.Commands.UpdateEmployeeSkill;
using Energy.Application.Organization.EmployeeSkill.Queries.GetEmployeeSkillById;
using Energy.Application.Organization.EmployeeSkill.Queries.GetEmployeeSkillList;
using Energy.Application.Organization.EmployeeSkill.Queries.GetEmployeeSkillLookup;
