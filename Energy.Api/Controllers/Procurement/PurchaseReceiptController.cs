...
using Energy.Application.Modules.Procurement.PurchaseReceipt.Commands.CreatePurchaseReceipt;
using Energy.Application.Modules.Procurement.PurchaseReceipt.Commands.DeletePurchaseReceipt;
using Energy.Application.Modules.Procurement.PurchaseReceipt.Commands.UpdatePurchaseReceipt;
using Energy.Application.Modules.Procurement.PurchaseReceipt.Queries.GetPurchaseReceiptById;
using Energy.Application.Modules.Procurement.PurchaseReceipt.Queries.GetPurchaseReceiptList;
using Energy.Application.Modules.Procurement.PurchaseReceipt.Queries.GetPurchaseReceiptLookup;
