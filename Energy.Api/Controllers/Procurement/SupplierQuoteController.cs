...
using Energy.Application.Procurement.SupplierQuote.Commands.CreateSupplierQuote;
using Energy.Application.Procurement.SupplierQuote.Commands.DeleteSupplierQuote;
using Energy.Application.Procurement.SupplierQuote.Commands.UpdateSupplierQuote;
using Energy.Application.Procurement.SupplierQuote.Queries.GetSupplierQuoteById;
using Energy.Application.Procurement.SupplierQuote.Queries.GetSupplierQuoteList;
using Energy.Application.Procurement.SupplierQuote.Queries.GetSupplierQuoteLookup;
