...
using Energy.Application.ProgressPayments.ProgressPaymentDeduction.Commands.CreateProgressPaymentDeduction;
using Energy.Application.ProgressPayments.ProgressPaymentDeduction.Commands.DeleteProgressPaymentDeduction;
using Energy.Application.ProgressPayments.ProgressPaymentDeduction.Commands.UpdateProgressPaymentDeduction;
using Energy.Application.ProgressPayments.ProgressPaymentDeduction.Queries.GetProgressPaymentDeductionById;
using Energy.Application.ProgressPayments.ProgressPaymentDeduction.Queries.GetProgressPaymentDeductionList;
using Energy.Application.ProgressPayments.ProgressPaymentDeduction.Queries.GetProgressPaymentDeductionLookup;
