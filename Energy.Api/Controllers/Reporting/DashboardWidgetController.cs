...
using Energy.Application.Reporting.DashboardWidget.Commands.CreateDashboardWidget;
using Energy.Application.Reporting.DashboardWidget.Commands.DeleteDashboardWidget;
using Energy.Application.Reporting.DashboardWidget.Commands.UpdateDashboardWidget;
using Energy.Application.Reporting.DashboardWidget.Queries.GetDashboardWidgetById;
using Energy.Application.Reporting.DashboardWidget.Queries.GetDashboardWidgetList;
using Energy.Application.Reporting.DashboardWidget.Queries.GetDashboardWidgetLookup;
