...
using Energy.Application.Modules.Workflow.ApprovalDefinition.Commands.CreateApprovalDefinition;
using Energy.Application.Modules.Workflow.ApprovalDefinition.Commands.DeleteApprovalDefinition;
using Energy.Application.Modules.Workflow.ApprovalDefinition.Commands.UpdateApprovalDefinition;
using Energy.Application.Modules.Workflow.ApprovalDefinition.Queries.GetApprovalDefinitionById;
using Energy.Application.Modules.Workflow.ApprovalDefinition.Queries.GetApprovalDefinitionList;
using Energy.Application.Modules.Workflow.ApprovalDefinition.Queries.GetApprovalDefinitionLookup;
