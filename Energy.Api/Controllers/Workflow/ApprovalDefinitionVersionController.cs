...
using Energy.Application.Modules.Workflow.ApprovalDefinitionVersion.Commands.CreateApprovalDefinitionVersion;
using Energy.Application.Modules.Workflow.ApprovalDefinitionVersion.Commands.DeleteApprovalDefinitionVersion;
using Energy.Application.Modules.Workflow.ApprovalDefinitionVersion.Commands.UpdateApprovalDefinitionVersion;
using Energy.Application.Modules.Workflow.ApprovalDefinitionVersion.Queries.GetApprovalDefinitionVersionById;
using Energy.Application.Modules.Workflow.ApprovalDefinitionVersion.Queries.GetApprovalDefinitionVersionList;
using Energy.Application.Modules.Workflow.ApprovalDefinitionVersion.Queries.GetApprovalDefinitionVersionLookup;
