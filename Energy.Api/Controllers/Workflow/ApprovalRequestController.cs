...
using Energy.Application.Workflow.ApprovalRequest.Commands.CreateApprovalRequest;
using Energy.Application.Workflow.ApprovalRequest.Commands.DeleteApprovalRequest;
using Energy.Application.Workflow.ApprovalRequest.Commands.UpdateApprovalRequest;
using Energy.Application.Workflow.ApprovalRequest.Queries.GetApprovalRequestById;
using Energy.Application.Workflow.ApprovalRequest.Queries.GetApprovalRequestList;
using Energy.Application.Workflow.ApprovalRequest.Queries.GetApprovalRequestLookup;
