...
namespace Energy.Application.Modules.Contracts.ContractAmendment.Services;

/// <summary>ContractAmendment CRUD use-case sözleşmesi.</summary>
public interface IContractAmendmentService
{
    /// <summary>Sayfalanmış ContractAmendment listesi.</summary>
    Task<BaseResponse<PaginatedResponse<ContractAmendmentListResponse>>> GetListAsync(GetContractAmendmentListRequest request, CancellationToken ct = default);
