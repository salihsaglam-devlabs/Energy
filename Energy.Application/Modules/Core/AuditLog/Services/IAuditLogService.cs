...
namespace Energy.Application.Modules.Core.AuditLog.Services;

/// <summary>AuditLog CRUD use-case sözleşmesi.</summary>
public interface IAuditLogService
{
    /// <summary>Sayfalanmış AuditLog listesi.</summary>
    Task<BaseResponse<PaginatedResponse<AuditLogListResponse>>> GetListAsync(GetAuditLogListRequest request, CancellationToken ct = default);
