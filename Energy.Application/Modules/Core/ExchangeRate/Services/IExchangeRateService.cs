...
namespace Energy.Application.Modules.Core.ExchangeRate.Services;

/// <summary>ExchangeRate CRUD use-case sözleşmesi.</summary>
public interface IExchangeRateService
{
    /// <summary>Sayfalanmış ExchangeRate listesi.</summary>
    Task<BaseResponse<PaginatedResponse<ExchangeRateListResponse>>> GetListAsync(GetExchangeRateListRequest request, CancellationToken ct = default);
