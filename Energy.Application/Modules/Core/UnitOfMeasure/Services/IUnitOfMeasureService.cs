...
namespace Energy.Application.Modules.Core.UnitOfMeasure.Services;

/// <summary>UnitOfMeasure CRUD use-case sözleşmesi.</summary>
public interface IUnitOfMeasureService
{
    /// <summary>Sayfalanmış UnitOfMeasure listesi.</summary>
    Task<BaseResponse<PaginatedResponse<UnitOfMeasureListResponse>>> GetListAsync(GetUnitOfMeasureListRequest request, CancellationToken ct = default);
