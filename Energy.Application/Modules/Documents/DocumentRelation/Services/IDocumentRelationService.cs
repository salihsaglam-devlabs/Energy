...
namespace Energy.Application.Modules.Documents.DocumentRelation.Services;

/// <summary>DocumentRelation CRUD use-case sözleşmesi.</summary>
public interface IDocumentRelationService
{
    /// <summary>Sayfalanmış DocumentRelation listesi.</summary>
    Task<BaseResponse<PaginatedResponse<DocumentRelationListResponse>>> GetListAsync(GetDocumentRelationListRequest request, CancellationToken ct = default);
