...
namespace Energy.Application.Modules.Inventory.StockDocumentType.Services;

/// <summary>StockDocumentType CRUD use-case sözleşmesi.</summary>
public interface IStockDocumentTypeService
{
    /// <summary>Sayfalanmış StockDocumentType listesi.</summary>
    Task<BaseResponse<PaginatedResponse<StockDocumentTypeListResponse>>> GetListAsync(GetStockDocumentTypeListRequest request, CancellationToken ct = default);
