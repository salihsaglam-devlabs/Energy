...
namespace Energy.Application.Modules.Inventory.WarehouseTransferLine.Services;

/// <summary>WarehouseTransferLine CRUD use-case sözleşmesi.</summary>
public interface IWarehouseTransferLineService
{
    /// <summary>Sayfalanmış WarehouseTransferLine listesi.</summary>
    Task<BaseResponse<PaginatedResponse<WarehouseTransferLineListResponse>>> GetListAsync(GetWarehouseTransferLineListRequest request, CancellationToken ct = default);
