...
namespace Energy.Application.Modules.Procurement.PurchaseOrder.Services;

/// <summary>PurchaseOrder CRUD use-case sözleşmesi.</summary>
public interface IPurchaseOrderService
{
    /// <summary>Sayfalanmış PurchaseOrder listesi.</summary>
    Task<BaseResponse<PaginatedResponse<PurchaseOrderListResponse>>> GetListAsync(GetPurchaseOrderListRequest request, CancellationToken ct = default);
