...
namespace Energy.Application.Modules.Procurement.PurchaseReceipt.Services;

/// <summary>PurchaseReceipt CRUD use-case sözleşmesi.</summary>
public interface IPurchaseReceiptService
{
    /// <summary>Sayfalanmış PurchaseReceipt listesi.</summary>
    Task<BaseResponse<PaginatedResponse<PurchaseReceiptListResponse>>> GetListAsync(GetPurchaseReceiptListRequest request, CancellationToken ct = default);
