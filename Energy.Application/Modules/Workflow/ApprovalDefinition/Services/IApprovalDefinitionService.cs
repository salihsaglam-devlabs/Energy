...
namespace Energy.Application.Modules.Workflow.ApprovalDefinition.Services;

/// <summary>ApprovalDefinition CRUD use-case sözleşmesi.</summary>
public interface IApprovalDefinitionService
{
    /// <summary>Sayfalanmış ApprovalDefinition listesi.</summary>
    Task<BaseResponse<PaginatedResponse<ApprovalDefinitionListResponse>>> GetListAsync(GetApprovalDefinitionListRequest request, CancellationToken ct = default);
