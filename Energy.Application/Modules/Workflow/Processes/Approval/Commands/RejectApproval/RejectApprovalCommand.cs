...
namespace Energy.Application.Modules.Workflow.Processes.Approval.Commands.RejectApproval;

/// <summary>Onay talebini reddeder (kaynak belge Approved olmaz) use-case'i.</summary>
...
public sealed record RejectApprovalCommand(Guid Id, Guid ActingUserId, string? Note)
