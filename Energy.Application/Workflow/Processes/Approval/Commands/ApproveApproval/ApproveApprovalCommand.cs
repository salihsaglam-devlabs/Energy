...
namespace Energy.Application.Workflow.Processes.Approval.Commands.ApproveApproval;

/// <summary>Onay talebini onaylar (sıradaki adıma ilerletir/tamamlar) use-case'i.</summary>
...
public sealed record ApproveApprovalCommand(Guid Id, Guid ActingUserId, string? Note)
