...
namespace Energy.Infrastructure.BusinessPartners.BusinessPartnerBankAccount.Services;
...
public class BusinessPartnerBankAccountService : IBusinessPartnerBankAccountService
{
    ...
    public BusinessPartnerBankAccountService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.BusinessPartners.BusinessPartnerBankAccount
        {
            Id = Guid.NewGuid(),
