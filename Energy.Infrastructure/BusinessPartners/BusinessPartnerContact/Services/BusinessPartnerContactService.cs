...
namespace Energy.Infrastructure.BusinessPartners.BusinessPartnerContact.Services;
...
public class BusinessPartnerContactService : IBusinessPartnerContactService
{
    ...
    public BusinessPartnerContactService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.BusinessPartners.BusinessPartnerContact
        {
            Id = Guid.NewGuid(),
