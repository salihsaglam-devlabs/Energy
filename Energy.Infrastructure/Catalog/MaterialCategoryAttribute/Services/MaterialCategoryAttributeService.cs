...
using Energy.Application.Catalog.MaterialCategoryAttribute.Services;
...
namespace Energy.Infrastructure.Catalog.MaterialCategoryAttribute.Services;
...
public class MaterialCategoryAttributeService : IMaterialCategoryAttributeService
{
    ...
    public MaterialCategoryAttributeService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Catalog.MaterialCategoryAttribute
        {
            Id = Guid.NewGuid(),
