...
public class ChatGroupMemberService : IChatGroupMemberService
{
    ...
    {
        var entity = new global::Energy.Domain.Chat.ChatGroupMember
        {
            Id = Guid.NewGuid(),
