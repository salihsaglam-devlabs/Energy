...
using Energy.Application.Chat.ChatMessageReaction.Services;
...
namespace Energy.Infrastructure.Chat.ChatMessageReaction.Services;
...
public class ChatMessageReactionService : IChatMessageReactionService
{
    ...
    public ChatMessageReactionService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Chat.ChatMessageReaction
        {
            Id = Guid.NewGuid(),
