...
using Energy.Application.Documents.DocumentPermission.Services;
...
namespace Energy.Infrastructure.Documents.DocumentPermission.Services;
...
public class DocumentPermissionService : IDocumentPermissionService
{
    ...
    {
        var entity = new global::Energy.Domain.Documents.DocumentPermission
        {
            Id = Guid.NewGuid(),
