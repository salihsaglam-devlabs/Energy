...
namespace Energy.Infrastructure.Documents.Files;
...
public sealed class DocumentFileService : IDocumentFileService
{
        ...
        Guid documentId, Stream content, string fileName, string? contentType, long size, CancellationToken ct = default)
    {
        ...
        try
        {
            var version = new global::Energy.Domain.Documents.DocumentVersion
            {
                Id = Guid.NewGuid(),
    ...
    private static DocumentVersionFileResponse Map(global::Energy.Domain.Documents.DocumentVersion v) => new()
    {
        Id = v.Id,
        DocumentId = v.DocumentId,
        VersionNo = v.VersionNo,
