...
namespace Energy.Infrastructure.FieldOperations.DailySiteReportEquipment.Services;
...
public class DailySiteReportEquipmentService : IDailySiteReportEquipmentService
{
    ...
    public DailySiteReportEquipmentService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.FieldOperations.DailySiteReportEquipment
        {
            Id = Guid.NewGuid(),
