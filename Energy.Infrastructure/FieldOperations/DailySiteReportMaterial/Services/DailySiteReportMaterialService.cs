...
namespace Energy.Infrastructure.FieldOperations.DailySiteReportMaterial.Services;
...
public class DailySiteReportMaterialService : IDailySiteReportMaterialService
{
    ...
    {
        var entity = new global::Energy.Domain.FieldOperations.DailySiteReportMaterial
        {
            Id = Guid.NewGuid(),
