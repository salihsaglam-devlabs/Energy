...
namespace Energy.Infrastructure.FieldOperations.DailySiteReportWorker.Services;
...
public class DailySiteReportWorkerService : IDailySiteReportWorkerService
{
    ...
    {
        var entity = new global::Energy.Domain.FieldOperations.DailySiteReportWorker
        {
            Id = Guid.NewGuid(),
