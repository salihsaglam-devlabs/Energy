...
namespace Energy.Infrastructure.Finance.CostCenter.Services;
...
public class CostCenterService : ICostCenterService
{
    ...
    public CostCenterService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Finance.CostCenter
        {
            Id = Guid.NewGuid(),
