...
namespace Energy.Infrastructure.Finance.Payable.Services;
...
public class PayableService : IPayableService
{
    ...
    public PayableService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Finance.Payable
        {
            Id = Guid.NewGuid(),
