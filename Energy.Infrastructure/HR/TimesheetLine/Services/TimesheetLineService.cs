...
namespace Energy.Infrastructure.HR.TimesheetLine.Services;
...
public class TimesheetLineService : ITimesheetLineService
{
    ...
    public TimesheetLineService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.HR.TimesheetLine
        {
            Id = Guid.NewGuid(),
