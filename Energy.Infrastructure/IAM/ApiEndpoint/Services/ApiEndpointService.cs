...
public class ApiEndpointService : IApiEndpointService
{
    ...
    {
        var entity = new global::Energy.Domain.IAM.ApiEndpoint
        {
            Id = Guid.NewGuid(),
            Path = request.Path,
