...
namespace Energy.Infrastructure.Inventory.StockDocumentType.Services;
...
public class StockDocumentTypeService : IStockDocumentTypeService
{
    ...
    public StockDocumentTypeService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Inventory.StockDocumentType
        {
            Id = Guid.NewGuid(),
            Code = request.Code,
            Name = request.Name,
