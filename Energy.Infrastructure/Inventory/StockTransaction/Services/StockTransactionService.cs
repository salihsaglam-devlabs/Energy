...
namespace Energy.Infrastructure.Inventory.StockTransaction.Services;
...
public class StockTransactionService : IStockTransactionService
{
    ...
    public StockTransactionService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Inventory.StockTransaction
        {
            Id = Guid.NewGuid(),
