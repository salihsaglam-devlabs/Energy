...
namespace Energy.Infrastructure.Inventory.WarehouseTransfer.Services;
...
public class WarehouseTransferService : IWarehouseTransferService
{
    ...
    public WarehouseTransferService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Inventory.WarehouseTransfer
        {
            Id = Guid.NewGuid(),
