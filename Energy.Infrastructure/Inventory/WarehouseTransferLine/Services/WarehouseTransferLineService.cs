...
namespace Energy.Infrastructure.Inventory.WarehouseTransferLine.Services;
...
public class WarehouseTransferLineService : IWarehouseTransferLineService
{
    ...
    public WarehouseTransferLineService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Inventory.WarehouseTransferLine
        {
            Id = Guid.NewGuid(),
