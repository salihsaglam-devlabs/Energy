...
namespace Energy.Infrastructure.Modules.Assets.EquipmentAsset.Services;
...
public class EquipmentAssetService : IEquipmentAssetService
{
    ...
    public EquipmentAssetService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Assets.EquipmentAsset
        {
            Id = Guid.NewGuid(),
