...
namespace Energy.Infrastructure.Modules.Budget.BudgetLine.Services;
...
public class BudgetLineService : IBudgetLineService
{
    ...
    public BudgetLineService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Budget.BudgetLine
        {
            Id = Guid.NewGuid(),
