...
namespace Energy.Infrastructure.Modules.BusinessPartners.BusinessPartnerAddress.Services;
...
public class BusinessPartnerAddressService : IBusinessPartnerAddressService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.BusinessPartners.BusinessPartnerAddress
        {
            Id = Guid.NewGuid(),
