...
namespace Energy.Infrastructure.Modules.Catalog.MaterialAttributeDefinition.Services;
...
public class MaterialAttributeDefinitionService : IMaterialAttributeDefinitionService
{
    ...
    public MaterialAttributeDefinitionService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Catalog.MaterialAttributeDefinition
        {
            Id = Guid.NewGuid(),
            Code = request.Code,
            Name = request.Name,
