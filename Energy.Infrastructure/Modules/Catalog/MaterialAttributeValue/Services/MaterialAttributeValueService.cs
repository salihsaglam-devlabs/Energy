...
namespace Energy.Infrastructure.Modules.Catalog.MaterialAttributeValue.Services;
...
public class MaterialAttributeValueService : IMaterialAttributeValueService
{
    ...
    public MaterialAttributeValueService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Catalog.MaterialAttributeValue
        {
            Id = Guid.NewGuid(),
