...
using Energy.Application.Modules.Chat.ChatGroup.Services;
using Energy.Shared.Models.V1.Chat.ChatGroup.Requests;
using Energy.Shared.Models.V1.Chat.ChatGroup.Responses;

namespace Energy.Infrastructure.Modules.Chat.ChatGroup.Services;
...
public class ChatGroupService : IChatGroupService
{
    ...
    public ChatGroupService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Chat.ChatGroup
        {
            Id = Guid.NewGuid(),
