...
using Energy.Application.Modules.Chat.ChatMessage.Services;
using Energy.Shared.Models.V1.Chat.ChatMessage.Requests;
using Energy.Shared.Models.V1.Chat.ChatMessage.Responses;

namespace Energy.Infrastructure.Modules.Chat.ChatMessage.Services;
...
public class ChatMessageService : IChatMessageService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.Chat.ChatMessage
        {
            Id = Guid.NewGuid(),
