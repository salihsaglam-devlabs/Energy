...
namespace Energy.Infrastructure.Modules.Contracts.Contract.Services;
...
public class ContractService : IContractService
{
    ...
    public ContractService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Contracts.Contract
        {
            Id = Guid.NewGuid(),
