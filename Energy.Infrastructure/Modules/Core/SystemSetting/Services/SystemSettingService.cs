...
namespace Energy.Infrastructure.Modules.Core.SystemSetting.Services;
...
public class SystemSettingService : ISystemSettingService
{
    ...
    public SystemSettingService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Core.SystemSetting
        {
            Id = Guid.NewGuid(),
            Key = request.Key,
            Value = request.Value,
