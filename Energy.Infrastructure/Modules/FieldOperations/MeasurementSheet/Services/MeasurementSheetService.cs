...
namespace Energy.Infrastructure.Modules.FieldOperations.MeasurementSheet.Services;
...
public class MeasurementSheetService : IMeasurementSheetService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.FieldOperations.MeasurementSheet
        {
            Id = Guid.NewGuid(),
