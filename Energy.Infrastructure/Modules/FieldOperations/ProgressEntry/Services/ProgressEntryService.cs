...
namespace Energy.Infrastructure.Modules.FieldOperations.ProgressEntry.Services;
...
public class ProgressEntryService : IProgressEntryService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.FieldOperations.ProgressEntry
        {
            Id = Guid.NewGuid(),
