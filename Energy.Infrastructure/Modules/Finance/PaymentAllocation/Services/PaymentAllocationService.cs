...
namespace Energy.Infrastructure.Modules.Finance.PaymentAllocation.Services;
...
public class PaymentAllocationService : IPaymentAllocationService
{
    ...
    public PaymentAllocationService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Finance.PaymentAllocation
        {
            Id = Guid.NewGuid(),
