...
using Energy.Application.Modules.IAM.Role.Services;
using Energy.Shared.Models.V1.IAM.Role.Requests;
using Energy.Shared.Models.V1.IAM.Role.Responses;

namespace Energy.Infrastructure.Modules.IAM.Role.Services;
...
public class RoleService : IRoleService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.IAM.Role
        {
            Id = Guid.NewGuid(),
            Name = request.Name,
