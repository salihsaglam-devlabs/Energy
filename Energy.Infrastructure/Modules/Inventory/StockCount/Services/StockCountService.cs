...
namespace Energy.Infrastructure.Modules.Inventory.StockCount.Services;
...
public class StockCountService : IStockCountService
{
    ...
    public StockCountService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Inventory.StockCount
        {
            Id = Guid.NewGuid(),
