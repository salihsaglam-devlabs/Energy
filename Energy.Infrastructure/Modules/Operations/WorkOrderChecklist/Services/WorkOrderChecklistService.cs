...
namespace Energy.Infrastructure.Modules.Operations.WorkOrderChecklist.Services;
...
public class WorkOrderChecklistService : IWorkOrderChecklistService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.Operations.WorkOrderChecklist
        {
            Id = Guid.NewGuid(),
