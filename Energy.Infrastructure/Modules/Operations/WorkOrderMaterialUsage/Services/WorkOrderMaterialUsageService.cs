...
namespace Energy.Infrastructure.Modules.Operations.WorkOrderMaterialUsage.Services;
...
public class WorkOrderMaterialUsageService : IWorkOrderMaterialUsageService
{
    ...
    public WorkOrderMaterialUsageService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Operations.WorkOrderMaterialUsage
        {
            Id = Guid.NewGuid(),
