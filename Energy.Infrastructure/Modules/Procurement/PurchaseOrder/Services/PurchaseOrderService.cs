...
namespace Energy.Infrastructure.Modules.Procurement.PurchaseOrder.Services;
...
public class PurchaseOrderService : IPurchaseOrderService
{
    ...
    public PurchaseOrderService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Procurement.PurchaseOrder
        {
            Id = Guid.NewGuid(),
