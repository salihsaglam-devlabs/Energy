...
namespace Energy.Infrastructure.Modules.Procurement.PurchaseOrderLine.Services;
...
public class PurchaseOrderLineService : IPurchaseOrderLineService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.Procurement.PurchaseOrderLine
        {
            Id = Guid.NewGuid(),
