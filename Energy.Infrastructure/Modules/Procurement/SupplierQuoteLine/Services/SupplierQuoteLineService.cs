...
namespace Energy.Infrastructure.Modules.Procurement.SupplierQuoteLine.Services;
...
public class SupplierQuoteLineService : ISupplierQuoteLineService
{
    ...
    {
        var entity = new global::Energy.Domain.Modules.Procurement.SupplierQuoteLine
        {
            Id = Guid.NewGuid(),
