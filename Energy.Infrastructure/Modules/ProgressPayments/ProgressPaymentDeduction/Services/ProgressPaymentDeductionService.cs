...
namespace Energy.Infrastructure.Modules.ProgressPayments.ProgressPaymentDeduction.Services;
...
public class ProgressPaymentDeductionService : IProgressPaymentDeductionService
{
    ...
    public ProgressPaymentDeductionService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.ProgressPayments.ProgressPaymentDeduction
        {
            Id = Guid.NewGuid(),
