...
namespace Energy.Infrastructure.Modules.Projects.Project.Services;
...
public class ProjectService : IProjectService
{
    ...
    public ProjectService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Projects.Project
        {
            Id = Guid.NewGuid(),
