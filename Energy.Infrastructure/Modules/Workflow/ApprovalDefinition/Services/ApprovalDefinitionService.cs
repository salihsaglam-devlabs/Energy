...
namespace Energy.Infrastructure.Modules.Workflow.ApprovalDefinition.Services;
...
public class ApprovalDefinitionService : IApprovalDefinitionService
{
    ...
    public ApprovalDefinitionService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Workflow.ApprovalDefinition
        {
            Id = Guid.NewGuid(),
            Code = request.Code,
            Name = request.Name,
