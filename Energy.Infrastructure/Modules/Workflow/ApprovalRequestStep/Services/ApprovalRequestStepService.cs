...
namespace Energy.Infrastructure.Modules.Workflow.ApprovalRequestStep.Services;
...
public class ApprovalRequestStepService : IApprovalRequestStepService
{
    ...
    public ApprovalRequestStepService(EnergyDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Modules.Workflow.ApprovalRequestStep
        {
            Id = Guid.NewGuid(),
