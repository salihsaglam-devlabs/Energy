...
namespace Energy.Infrastructure.Notifications.NotificationRecipient.Services;
...
public class NotificationRecipientService : INotificationRecipientService
{
    ...
    public NotificationRecipientService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Notifications.NotificationRecipient
        {
            Id = Guid.NewGuid(),
