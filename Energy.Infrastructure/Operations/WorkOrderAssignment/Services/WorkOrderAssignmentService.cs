...
namespace Energy.Infrastructure.Operations.WorkOrderAssignment.Services;
...
public class WorkOrderAssignmentService : IWorkOrderAssignmentService
{
    ...
    public WorkOrderAssignmentService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Operations.WorkOrderAssignment
        {
            Id = Guid.NewGuid(),
