...
namespace Energy.Infrastructure.Operations.WorkOrderMaterialPlan.Services;
...
public class WorkOrderMaterialPlanService : IWorkOrderMaterialPlanService
{
    ...
    public WorkOrderMaterialPlanService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Operations.WorkOrderMaterialPlan
        {
            Id = Guid.NewGuid(),
