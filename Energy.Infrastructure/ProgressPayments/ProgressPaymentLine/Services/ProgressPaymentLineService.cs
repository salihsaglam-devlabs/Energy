...
namespace Energy.Infrastructure.ProgressPayments.ProgressPaymentLine.Services;
...
public class ProgressPaymentLineService : IProgressPaymentLineService
{
    ...
    public ProgressPaymentLineService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.ProgressPayments.ProgressPaymentLine
        {
            Id = Guid.NewGuid(),
