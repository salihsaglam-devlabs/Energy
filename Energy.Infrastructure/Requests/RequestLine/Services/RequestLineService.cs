...
namespace Energy.Infrastructure.Requests.RequestLine.Services;
...
public class RequestLineService : IRequestLineService
{
    ...
    public RequestLineService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Requests.RequestLine
        {
            Id = Guid.NewGuid(),
