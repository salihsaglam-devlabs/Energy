...
namespace Energy.Infrastructure.Requests.RequestType.Services;
...
public class RequestTypeService : IRequestTypeService
{
    ...
    public RequestTypeService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Requests.RequestType
        {
            Id = Guid.NewGuid(),
            Code = request.Code,
            Name = request.Name,
