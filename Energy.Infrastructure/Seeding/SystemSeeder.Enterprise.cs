...
public sealed partial class SystemSeeder
{
    ...
    private async Task SeedEnterpriseDataAsync(CancellationToken ct)
    {

        _logger.LogInformation("Seeding: enterprise reference data (currencies, units)");
        await EnsureEnterpriseReferenceDataAsync(ct);
    ...
    /// </summary>
    private async Task EnsureEnterpriseSchemaAsync(CancellationToken ct)
    {
    ...
    private async Task EnsureEnterpriseReferenceDataAsync(CancellationToken ct)
    {
    ...
    private async Task EnsureEnterpriseMenusAsync(CancellationToken ct)
    {
