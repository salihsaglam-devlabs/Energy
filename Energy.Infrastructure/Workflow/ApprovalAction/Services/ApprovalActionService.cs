...
namespace Energy.Infrastructure.Workflow.ApprovalAction.Services;
...
public class ApprovalActionService : IApprovalActionService
{
    ...
    public ApprovalActionService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Workflow.ApprovalAction
        {
            Id = Guid.NewGuid(),
