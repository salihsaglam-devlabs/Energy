...
namespace Energy.Infrastructure.Workflow.ApprovalRequest.Services;
...
public class ApprovalRequestService : IApprovalRequestService
{
    ...
    public ApprovalRequestService(AppDbContext db) => _db = db;
    ...
    {
        var entity = new global::Energy.Domain.Workflow.ApprovalRequest
        {
            Id = Guid.NewGuid(),
