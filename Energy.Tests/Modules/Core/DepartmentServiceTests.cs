...
using Energy.Infrastructure.Modules.Core.Department.Services;
...
/// <summary>Department CRUD servisi round-trip testi (EF InMemory).</summary>
public sealed class DepartmentServiceTests
{
    ...
    public async Task Create_Get_Update_Delete_RoundTrips()
    {
        ...
        var updated = await service.UpdateAsync(id, new UpdateDepartmentRequest { Id = id });
