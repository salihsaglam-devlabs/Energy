...
using Energy.Infrastructure.Modules.IAM.Role.Services;
...
/// <summary>Role CRUD servisi round-trip testi (EF InMemory).</summary>
public sealed class RoleServiceTests
{
    ...
    public async Task Create_Get_Update_Delete_RoundTrips()
    {
        ...
        var updated = await service.UpdateAsync(id, new UpdateRoleRequest { Id = id });
