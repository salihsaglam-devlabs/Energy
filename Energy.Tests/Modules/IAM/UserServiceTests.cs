...
using Energy.Infrastructure.Modules.IAM.User.Services;
...
/// <summary>User CRUD servisi round-trip testi (EF InMemory).</summary>
public sealed class UserServiceTests
{
    ...
    public async Task Create_Get_Update_Delete_RoundTrips()
    {
        ...
        var updated = await service.UpdateAsync(id, new UpdateUserRequest { Id = id });
