...
using Energy.Web.Clients.FieldOperations.DailySiteReportEquipment;
...
public sealed class DailySiteReportEquipmentsController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/FieldOperations/DailySiteReportEquipment/Index.cshtml");
