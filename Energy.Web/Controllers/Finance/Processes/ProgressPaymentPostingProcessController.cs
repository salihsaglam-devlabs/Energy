...
using Energy.Web.Clients.Finance.Processes.ProgressPaymentPosting;
...
public sealed class ProgressPaymentPostingProcessController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Finance/Processes/ProgressPaymentPosting/Index.cshtml");
