...
using Energy.Web.Clients.HR.Reports.TimesheetSummary;

namespace Energy.Web.Controllers.HR.Reports;
...
public sealed class TimesheetSummaryController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/HR/Reports/TimesheetSummary/Index.cshtml");
