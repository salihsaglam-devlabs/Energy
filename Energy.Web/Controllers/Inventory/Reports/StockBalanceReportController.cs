...
using Energy.Web.Clients.Inventory.Reports.StockBalanceReport;

namespace Energy.Web.Controllers.Inventory.Reports;
...
public sealed class StockBalanceReportController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Inventory/Reports/StockBalanceReport/Index.cshtml");
