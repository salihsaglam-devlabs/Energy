...
using Energy.Web.Clients.Modules.FieldOperations.DailySiteReportWorker;
...
public sealed class DailySiteReportWorkersController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/FieldOperations/DailySiteReportWorker/Index.cshtml");
