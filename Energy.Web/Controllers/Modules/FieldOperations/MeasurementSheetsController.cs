...
using Energy.Web.Clients.Modules.FieldOperations.MeasurementSheet;
...
public sealed class MeasurementSheetsController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/FieldOperations/MeasurementSheet/Index.cshtml");
