...
using Energy.Web.Clients.Modules.Finance.Processes.TimesheetCost;
...
public sealed class TimesheetCostProcessController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Finance/Processes/TimesheetCost/Index.cshtml");
