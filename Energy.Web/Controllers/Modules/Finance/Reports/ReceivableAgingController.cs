...
using Energy.Web.Clients.Modules.Finance.Reports.ReceivableAging;
...
public sealed class ReceivableAgingController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Finance/Reports/ReceivableAging/Index.cshtml");
