...
using Energy.Web.Clients.Modules.Inventory.Processes.StockIssue;
...
public sealed class StockIssueProcessController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Inventory/Processes/StockIssue/Index.cshtml");
