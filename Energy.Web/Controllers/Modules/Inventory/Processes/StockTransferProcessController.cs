...
using Energy.Web.Clients.Modules.Inventory.Processes.StockTransfer;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace Energy.Web.Controllers.Modules.Inventory.Processes;
...
public sealed class StockTransferProcessController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Inventory/Processes/StockTransfer/Index.cshtml");
