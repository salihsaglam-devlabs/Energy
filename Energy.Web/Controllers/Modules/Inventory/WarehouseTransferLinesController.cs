...
using Energy.Web.Clients.Modules.Inventory.WarehouseTransferLine;
...
public sealed class WarehouseTransferLinesController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Inventory/WarehouseTransferLine/Index.cshtml");
