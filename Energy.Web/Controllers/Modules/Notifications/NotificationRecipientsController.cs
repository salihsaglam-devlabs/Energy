...
using Energy.Web.Clients.Modules.Notifications.NotificationRecipient;
...
public sealed class NotificationRecipientsController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Notifications/NotificationRecipient/Index.cshtml");
