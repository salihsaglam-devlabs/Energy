...
using Energy.Web.Clients.Modules.Operations.WorkOrderAssignment;
...
public sealed class WorkOrderAssignmentsController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Operations/WorkOrderAssignment/Index.cshtml");
