...
using Energy.Web.Clients.Modules.Organization.EmployeeSkillAssignment;
...
public sealed class EmployeeSkillAssignmentsController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Organization/EmployeeSkillAssignment/Index.cshtml");
