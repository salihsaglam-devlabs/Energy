...
using Energy.Web.Clients.Modules.Organization.ExpenseClaimLine;
...
public sealed class ExpenseClaimLinesController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Organization/ExpenseClaimLine/Index.cshtml");
