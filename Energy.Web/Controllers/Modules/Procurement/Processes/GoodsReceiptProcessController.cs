...
using Energy.Web.Clients.Modules.Procurement.Processes.GoodsReceipt;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace Energy.Web.Controllers.Modules.Procurement.Processes;
...
public sealed class GoodsReceiptProcessController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Procurement/Processes/GoodsReceipt/Index.cshtml");
