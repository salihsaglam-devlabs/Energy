...
using Energy.Web.Clients.Modules.Procurement.Reports.PurchaseOrderSummary;

namespace Energy.Web.Controllers.Modules.Procurement.Reports;
...
public sealed class PurchaseOrderSummaryController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Procurement/Reports/PurchaseOrderSummary/Index.cshtml");
