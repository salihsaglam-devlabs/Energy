...
using Energy.Web.Clients.Modules.ProgressPayments.ProgressPaymentLine;
...
public sealed class ProgressPaymentLinesController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/ProgressPayments/ProgressPaymentLine/Index.cshtml");
