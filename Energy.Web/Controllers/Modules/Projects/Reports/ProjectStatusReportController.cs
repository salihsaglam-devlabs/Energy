...
using Energy.Web.Clients.Modules.Projects.Reports.ProjectStatusReport;

namespace Energy.Web.Controllers.Modules.Projects.Reports;
...
public sealed class ProjectStatusReportController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Projects/Reports/ProjectStatusReport/Index.cshtml");
