...
using Energy.Web.Clients.Modules.Workflow.ApprovalDefinitionVersion;
...
public sealed class ApprovalDefinitionVersionsController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Workflow/ApprovalDefinitionVersion/Index.cshtml");
