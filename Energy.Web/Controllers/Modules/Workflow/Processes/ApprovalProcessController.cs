...
using Energy.Web.Clients.Modules.Workflow.Processes.Approval;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace Energy.Web.Controllers.Modules.Workflow.Processes;
...
public sealed class ApprovalProcessController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/Modules/Workflow/Processes/Approval/Index.cshtml");
