...
using Energy.Web.Clients.ProgressPayments.Reports.ProgressPaymentSummary;

namespace Energy.Web.Controllers.ProgressPayments.Reports;
...
public sealed class ProgressPaymentSummaryController : Controller
{
    ...
    [HttpGet("")]
    public IActionResult Index() => View("~/Views/ProgressPayments/Reports/ProgressPaymentSummary/Index.cshtml");
