/*
 * BusinessPartners / BusinessPartnerBankAccount — entity-specific DevExtreme grid screen.
...
(function (window, $) {
    ...
    window.AppPages.BusinessPartnersBusinessPartnerBankAccount = { init: init };
