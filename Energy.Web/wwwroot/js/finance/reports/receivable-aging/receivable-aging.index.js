/*
 * Finance / ReceivableAging — read-only DevExtreme report screen.
...
(function (window, $) {
    ...
    function init(base, gridId, filtersId, opts) {
        ...
        var grid = $("#" + gridId).dxDataGrid({
            ...
            columns: [
            { dataField: "partnerId", caption: "PartnerId" },
            { dataField: "currencyId", caption: "CurrencyId" },
            { dataField: "amount", caption: "Amount", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { dataField: "remainingAmount", caption: "RemainingAmount", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { dataField: "dueDate", caption: "DueDate", dataType: "date" },
            { dataField: "isClosed", caption: "IsClosed", dataType: "boolean" }
            ]
        }).dxDataGrid("instance");
    ...
    window.AppReports.FinanceReceivableAging = { init: init };
})(window, jQuery);
