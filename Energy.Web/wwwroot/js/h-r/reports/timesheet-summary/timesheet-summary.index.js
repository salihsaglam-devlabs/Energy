/*
 * HR / TimesheetSummary — read-only DevExtreme report screen.
...
(function (window, $) {
    ...
    function init(base, gridId, filtersId, opts) {
        ...
        var grid = $("#" + gridId).dxDataGrid({
            ...
            columns: [
            { dataField: "timesheetNo", caption: "TimesheetNo" },
            { dataField: "periodStart", caption: "PeriodStart", dataType: "date" },
            { dataField: "periodEnd", caption: "PeriodEnd", dataType: "date" },
    ...
    window.AppReports.HRTimesheetSummary = { init: init };
})(window, jQuery);
