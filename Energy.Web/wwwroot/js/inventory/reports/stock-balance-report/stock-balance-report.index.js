...
(function (window, $) {
    ...
    function init(base, gridId, filtersId, opts) {
        ...
        var grid = $("#" + gridId).dxDataGrid({
            ...
            columns: [
            { dataField: "warehouseId", caption: "WarehouseId" },
            { dataField: "materialId", caption: "MaterialId" },
            { dataField: "quantity", caption: "Quantity", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { dataField: "reservedQuantity", caption: "ReservedQuantity", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { dataField: "totalCost", caption: "TotalCost", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { dataField: "lastRecalculatedAt", caption: "LastRecalculatedAt", dataType: "date" }
            ]
        }).dxDataGrid("instance");
