/*
 * Inventory / WarehouseLocation — entity-specific DevExtreme grid screen.
...
(function (window, $) {
    ...
    var LOOKUPS = {
        "parentLocationId": "/inventory/warehouse-locations/lookup",
    ...
    window.AppPages.InventoryWarehouseLocation = { init: init };
