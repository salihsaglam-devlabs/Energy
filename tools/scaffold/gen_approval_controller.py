...
path = os.path.join(root, "Energy.Api", "Controllers", "Workflow", "Processes", "ApprovalProcessController.cs")
content = '''using Asp.Versioning;
using MediatR;
using Microsoft.AspNetCore.Mvc;
using Energy.Application.Identity.Services;
using Energy.Application.Modules.Workflow.Processes.Approval.Commands.ApproveApproval;
using Energy.Application.Modules.Workflow.Processes.Approval.Commands.CancelApproval;
using Energy.Application.Modules.Workflow.Processes.Approval.Commands.RejectApproval;
using Energy.Application.Modules.Workflow.Processes.Approval.Queries.GetMyPendingApprovals;
